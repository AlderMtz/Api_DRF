...
INSTALLED_APPS = [
    ...
    'projects', #aqui agregamos la carpeta de la nueva app creada llamada "projects".
    'rest_framework', #agregamos tambien la aplicacion de terceros que vamos a utilizar.
]
